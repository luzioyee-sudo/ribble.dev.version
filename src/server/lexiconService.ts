...
import { UNIVERSITY_LIFE_AND_STUDIES_DATA } from '../data/universityLifeAndStudies.ts';
import { CAREER_GOALS_AND_BUSINESS_DATA } from '../data/careerGoalsAndBusiness.ts';
...
export function loadMasterLexicon(): void {
  ...
  // Seed initial master lexicon and all topic datasets if database has fewer than 100 entries
  if (Object.keys(lexiconMap).length < 100) {
    console.log('[Master Lexicon] Seeding initial master lexicon corpus and all topic datasets...');
    lexiconMap = {};
