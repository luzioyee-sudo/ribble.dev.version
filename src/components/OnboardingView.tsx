...
export const OnboardingView: React.FC<OnboardingViewProps> = ({ onComplete, settings }) => {
  ...
  return (
    <div className="min-h-[100dvh] w-full flex items-center justify-center bg-[#F5F5F7] dark:bg-[#121312] relative overflow-y-auto text-[#222222] dark:text-[#F5F5F7] p-4 sm:p-6 md:p-12">
      {/* Subtle brand ambient glow */}
      <div className="absolute top-0 end-0 w-[500px] sm:w-[800px] h-[500px] sm:h-[800px] bg-gradient-to-bl from-[#34C759]/20 via-[#F5F5F7]/0 to-transparent dark:from-[#34C759]/10 dark:via-[#121312]/0 blur-3xl pointer-events-none transform translate-x-1/3 -translate-y-1/3 rounded-full" />
      ...
      <div className="w-full max-w-xl md:max-w-2xl px-2 sm:px-6 md:px-10 relative z-10 flex flex-col justify-center my-auto py-6">
        <AnimatePresence mode="wait">
          {step === 0 && (
            ...
            >
              <div className="mb-6 sm:mb-10 text-[#222222] dark:text-[#34C759]">
              ...
              <input
                ...
                className="mt-8 sm:mt-12 w-full bg-transparent border-b border-[#D1D1D6] dark:border-[#2C2E2A] pb-3 sm:pb-4 text-2xl sm:text-3xl md:text-4xl text-[#222222] dark:text-white placeholder:text-[#999999] dark:placeholder:text-[#666666] outline-none focus:border-[#222222] dark:focus:border-[#34C759] transition-colors font-['Cabinet_Grotesk','Plus_Jakarta_Sans',sans-serif] min-h-[48px]"
                autoFocus
              />
              ...
              <div className="mt-8 sm:mt-12 flex items-center justify-between gap-4 flex-wrap">
                <button
                  ...
                  className={`px-8 py-3.5 rounded-full text-sm font-bold transition-all min-h-[48px] ${
                    name.trim() 
                      ? 'bg-[#222222] dark:bg-[#34C759] hover:bg-[#333333] dark:hover:bg-[#8AE88D] text-[#F5F5F7] dark:text-[#222222] cursor-pointer shadow-sm active:scale-95' 
                      : 'bg-[#D1D1D6] dark:bg-[#1E201D] text-[#999999] dark:text-[#666666] cursor-not-allowed'
                  }`}
                >
                  {t.continue || "Continue"}
                </button>
                ...
                <div className="flex items-center gap-3 sm:gap-4 flex-wrap">
                  <button
                    ...
                    onClick={() => {
                      ...
                      onComplete(name.trim() || 'Guest User', language);
                    }}
                    className="text-xs font-bold text-[#666666] hover:text-[#222222] dark:text-[#999999] dark:hover:text-[#34C759] transition-colors cursor-pointer py-2 px-1 flex items-center gap-1.5"
                  >
                    <User className="w-3.5 h-3.5" />
                    <span>{t.continueAsGuest || "Continue as Guest"}</span>
                  </button>
                  <span className="text-[#D1D1D6] dark:text-[#2C2E2A]">•</span>
                  <button
                    onClick={() => setStep(3)}
                    className="text-xs font-bold text-[#666666] hover:text-[#222222] dark:text-[#999999] dark:hover:text-[#34C759] transition-colors cursor-pointer py-2 px-1"
                  >
          ...
          {step === 1 && (
            ...
            >
              ...
              <div className="w-20 sm:w-24 h-[1.5px] bg-[#222222] dark:bg-[#34C759] my-6 sm:my-10" />
          ...
          {step === 2 && (
            ...
            >
              <div className="self-start px-2.5 py-1 bg-[#D1D1D6]/40 dark:bg-[#1E201D] text-[#222222] dark:text-[#34C759] text-[10px] font-bold tracking-[0.15em] uppercase rounded-full border border-[#D1D1D6]/60 dark:border-[#2C2E2A]">
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                {languages.map((lang) => (
                  <button
                    ...
                    className="px-5 sm:px-6 py-5 sm:py-6 rounded-[20px] border border-[#D1D1D6] dark:border-[#2C2E2A] bg-white dark:bg-[#1A1C19] hover:bg-[#F5F5F7] dark:hover:bg-[#252824] hover:border-[#222222] dark:hover:border-[#34C759] transition-all text-start group cursor-pointer shadow-xs hover:shadow-md"
                  >
                    <div className="flex items-center gap-3 sm:gap-4">
                      <span className="text-xs font-bold tracking-wide text-[#222222] dark:text-[#F5F5F7]">{lang.code}</span>
          ...
          {step === 3 && (
            ...
            >
              <div className="mb-4 sm:mb-6 text-[#222222] dark:text-[#F5F5F7] flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-xs font-bold text-[#666666] hover:text-[#222222] dark:text-[#999999] dark:hover:text-[#F5F5F7] transition-colors cursor-pointer py-1.5 px-3.5 bg-white dark:bg-[#1A1C19] hover:bg-[#F5F5F7] dark:hover:bg-[#252824] rounded-full border border-[#D1D1D6] dark:border-[#2C2E2A] shadow-xs flex items-center gap-1.5"
                >
                  <User className="w-3.5 h-3.5" />
                  <span>{t.continueAsGuest || "Continue as Guest"}</span>
                  <span>→</span>
              ...
              <div className="mt-6 sm:mt-8 flex flex-col gap-3.5 w-full max-w-md">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-3 px-5 py-3.5 rounded-2xl border border-[#D1D1D6] dark:border-[#2C2E2A] bg-white dark:bg-[#1A1C19] hover:bg-[#F5F5F7] dark:hover:bg-[#252824] text-[#222222] dark:text-[#F5F5F7] text-sm font-semibold transition-all cursor-pointer shadow-xs min-h-[48px] active:scale-[0.98]"
                >
                ...
                <div className="relative my-2 sm:my-3">
                  <div className="absolute inset-0 flex items-center">
                    <div className="w-full border-t border-[#D1D1D6] dark:border-[#2C2E2A]"></div>
                  </div>
                  <div className="relative flex justify-center text-[10px] font-bold tracking-wider uppercase">
                    <span className="px-3 bg-[#F5F5F7] dark:bg-[#121312] text-[#666666] dark:text-[#999999]">{t.orContinueWithEmail || "Or continue with email"}</span>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full ps-11 pe-4 py-3.5 rounded-2xl border border-[#D1D1D6] dark:border-[#2C2E2A] bg-white dark:bg-[#1A1C19] text-sm text-[#222222] dark:text-white placeholder:text-[#999999] dark:placeholder:text-[#666666] focus:border-[#222222] dark:focus:border-[#34C759] outline-none transition-all min-h-[48px]"
                  />
                </div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full ps-4 pe-11 py-3.5 rounded-2xl border border-[#D1D1D6] dark:border-[#2C2E2A] bg-white dark:bg-[#1A1C19] text-sm text-[#222222] dark:text-white placeholder:text-[#999999] dark:placeholder:text-[#666666] focus:border-[#222222] dark:focus:border-[#34C759] outline-none transition-all min-h-[48px]"
                  />
                  <button
                    type="button"
                ...
                <button
                  ...
                  className={`w-full px-6 py-3.5 rounded-2xl text-sm font-semibold transition-all shadow-xs min-h-[48px] flex items-center justify-center gap-2 ${
                    !email.trim() || !password.trim() || isLoading
                      ? 'bg-[#D1D1D6] dark:bg-[#1E201D] text-[#999999] dark:text-[#666666] cursor-not-allowed'
                      : 'bg-[#222222] dark:bg-[#34C759] text-[#F5F5F7] dark:text-[#222222] hover:bg-[#333333] dark:hover:bg-[#8AE88D] cursor-pointer active:scale-[0.98]'
                  }`}
                >
                ...
                <p className="text-center text-xs text-[#666666] dark:text-[#999999] mt-1">
                  ...
                  <button
                    ...
                    className="font-bold text-[#222222] dark:text-[#34C759] hover:underline cursor-pointer py-1"
                  >
                    {isLogin ? (t.signUp || 'Sign up') : (t.logIn || 'Log in')}
                  </button>
                </p>

                {/* Continue as Guest option without account */}
                <div className="relative my-2 sm:my-3">
                  <div className="absolute inset-0 flex items-center">
                    <div className="w-full border-t border-[#D1D1D6] dark:border-[#2C2E2A]"></div>
                  </div>
                  <div className="relative flex justify-center text-[10px] font-bold tracking-wider uppercase">
                    <span className="px-3 bg-[#F5F5F7] dark:bg-[#121312] text-[#666666] dark:text-[#999999]">{t.or || "Or"}</span>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2.5 py-3 px-4 rounded-2xl border border-dashed border-[#D1D1D6] dark:border-[#2C2E2A] hover:border-[#222222] dark:hover:border-[#34C759] bg-white/50 dark:bg-[#1A1C19]/50 hover:bg-white dark:hover:bg-[#1A1C19] text-xs sm:text-sm font-semibold text-[#222222] dark:text-[#F5F5F7] transition-all cursor-pointer min-h-[48px] active:scale-[0.98] shadow-xs"
                >
                  <User className="w-4 h-4 text-[#666666] dark:text-[#34C759]" />
                  <span>{t.continueAsGuest || "Continue as Guest"}</span>
                </button>
              </div>
              ...
              <div className="mt-6 sm:mt-8 flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-[#666666] dark:text-[#999999] text-xs hover:text-[#222222] dark:hover:text-white transition-colors cursor-pointer py-1 underline underline-offset-4"
                >
